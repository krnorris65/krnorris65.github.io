        ...
        if(event.target.value.length >= 3) {
            ...
            blogsFilter.forEach(returnedBlog => { 
                ...
                finalBlogString += `
                        ...
                        <header>
                        <h2 class="weekNum">${returnedBlog.title}</h2>
                        <p class="weekDate">${returnedBlog.week_dates}</p>
                        </header>
                ...
                finalBlogString += `
                        ...
                        <footer>
                        <span>Posted by ${returnedBlog.author} on ${returnedBlog.published}</time></span>
                        </footer>
